...
// [#5] Write a modified 'bmi_calculator.cpp' program that prompts the user to enter his/her weight and height, calculates, and
// displays a BMI classification based on the BMI value
int main() {
    // Declare Variables
